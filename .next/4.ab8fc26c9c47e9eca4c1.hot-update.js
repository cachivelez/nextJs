  ...
  _createClass(_default, [{
    ...
    value: function handleClickSort(arg) {
      ...
      switch (arg.title) {
        ...
        case "Highest price":
          {
            products = (_readOnlyError("products"), products.concat().sort(function (a, b) {
              return b.cost - a.cost;
            }));
          }

        default:
          products = (_readOnlyError("products"), products);
      }
...
//# sourceMappingURL=4.ab8fc26c9c47e9eca4c1.hot-update.js.map