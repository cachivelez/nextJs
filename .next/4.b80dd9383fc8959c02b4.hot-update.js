...
function (_React$Component) {
  ...
  function _default(props) {
    ...
    _this.handleClickRefresh = _this.handleClickRefresh.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(_default, [{
    ...
    key: "handleClickRefresh",
    value: function handleClickRefresh() {
      try {
        var _Promise$all = Promise.all([fetch("https://aerolab-challenge.now.sh/user/me?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI1Yjc2NTVjNGYyYjBlNzAwNTc5ZDgzODEiLCJpYXQiOjE1MzQ0ODE4NjB9.qthyWAKLfbrB-HQ9R26z8DAn-jfHrH4xOsQSwGCaiNk"), fetch("https://aerolab-challenge.now.sh/products?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI1Yjc2NTVjNGYyYjBlNzAwNTc5ZDgzODEiLCJpYXQiOjE1MzQ0ODE4NjB9.qthyWAKLfbrB-HQ9R26z8DAn-jfHrH4xOsQSwGCaiNk")]),
            _Promise$all2 = _slicedToArray(_Promise$all, 2),
            reqUser = _Promise$all2[0],
            reqProducts = _Promise$all2[1];
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__components_layout_LayoutFull__["a" /* default */], {
        ...
        user: user,
        products: products,
        eventRefreshCoins: this.handleClickRefresh,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 83
        }
...
//# sourceMappingURL=4.b80dd9383fc8959c02b4.hot-update.js.map