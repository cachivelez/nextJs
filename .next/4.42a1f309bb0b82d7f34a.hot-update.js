...
function (_React$Component) {
  ...
  function _default(props) {
    ...
    _this.handleClick = _this.handleClickPagination.bind(_assertThisInitialized(_this));
    return _this;
  }

  _createClass(_default, [{
    key: "handleClickPagination",
    value: function handleClickPagination(event) {
      console.log(this.state.currentpagenumber);
      this.setState({
        currentpagenumber: Number(this.state.currentpagenumber)
      });
    }
  }, {
    key: "render",
...
//# sourceMappingURL=4.42a1f309bb0b82d7f34a.hot-update.js.map