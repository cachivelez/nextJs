  ...
  _createClass(_default, [{
    ...
    value: function handleClickSort(arg) {
      ...
      switch (arg.title) {
        case "Lowest price":
          {
            var _productsAux2 = products.concat().sort(function (a, b) {
        ...
        case "Highest price":
          {
            var _productsAux3 = products.concat().sort(function (a, b) {
              return b.cost - a.cost;
            });
          }

        default:
          var _productsAux = products;
      }
...
//# sourceMappingURL=4.daabeb277bf6bf6abe24.hot-update.js.map